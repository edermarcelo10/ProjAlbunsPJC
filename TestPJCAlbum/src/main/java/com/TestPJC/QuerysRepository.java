...
public class QuerysRepository {
	...
	/*CONSULTAR TODOS ALBUM*/
	public static final String CONSULTAR_ALBUNS = "SELECT ID_ALBUM, DESCRICAO_ALBUM, ID_ARTISTA FROM CAD_ALBUM";
 
	/*SELECIONAR UM ALBUM PELO CODIGO*/
	public static final String SELECIONAR_ALBUM = "SELECT ID_ALBUM, DESCRICAO_ALBUM, ID_ARTISTA FROM CAD_ALBUM WHERE ID_ALBUM = ?";
